...
class Mesh : public Object
{
    ...
    // attribute: light intense for RGB
    std::vector<vec3> vertices_attr;
    Box box;
...
public:
    ...
    void Read_Obj(const char* file, const vec3& position);
    Box Bounding_Box(int part) const override;
    virtual void Update_GI(const vec3& energy, const vec3& P, int part) override;
