...
void Hierarchy::Build(std::vector<Entry>& entries){
...
void Hierarchy::Reorder_Entries(std::vector<Entry>& entries)
{
...
void Hierarchy::Build_Tree(std::vector<Entry>& entries)
{
    if(!entries.size()) return;
